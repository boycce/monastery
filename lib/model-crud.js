...
Model.prototype._throwCrudError = function (err, opts) {
  const formattedErr = util.formatDuplicateKeyError(this, err, true)
  if (formattedErr) err = formattedErr
